...
import { Sparkles, Linkedin, Twitter, Instagram, ArrowUpRight } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-zinc-200/80">
          ...
          <div className="md:col-span-4 space-y-6">
            <a href="#home" onClick={(e) => handleScrollTo(e, "#home")} className="inline-flex items-center space-x-1 group">
              <span className="text-4xl sm:text-5xl font-black tracking-tighter text-zinc-950 uppercase font-syne flex items-center">
                GEND<span className="text-sm font-bold align-super ml-0.5 text-zinc-400">®</span>
              </span>
            </a>
            
            <div className="space-y-2 text-xs font-bold uppercase tracking-wider text-zinc-500">
              <p>Callback line: <a href="tel:+15108956500" className="text-zinc-950 hover:text-[#ff4a22] transition-colors">(510) 895-6500</a></p>
              <p>Inquiry: <a href="mailto:hello@gendstudio.com" className="text-zinc-950 hover:text-[#ff4a22] transition-colors">hello@gendstudio.com</a></p>
            </div>
          </div>

          {/* Stay Connected Newsletter Input exactly like Reference Image 13 */}
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-xs text-zinc-500 font-medium leading-normal max-w-sm">
              Join our newsletter and stay updated on the latest trends in digital design, interactive branding, and paid media media strategies.
            </p>
          ...
          <div className="md:col-span-2 md:col-start-9 space-y-4">
            ...
            <ul className="space-y-2 text-xs font-bold uppercase tracking-wider text-zinc-600">
              <li>
                <a href="#about" onClick={(e) => handleScrollTo(e, "#about")} className="hover:text-[#ff4a22] transition-colors">
                  About us
                </a>
              </li>
              <li>
                <a href="#projects" onClick={(e) => handleScrollTo(e, "#projects")} className="hover:text-[#ff4a22] transition-colors">
                  Selected Work
                </a>
              </li>
              <li>
                <a href="#blog" onClick={(e) => handleScrollTo(e, "#blog")} className="hover:text-[#ff4a22] transition-colors">
                  Publications
                </a>
              </li>
              <li>
                <a href="#pricing" onClick={(e) => handleScrollTo(e, "#pricing")} className="hover:text-[#ff4a22] transition-colors">
                  Pricing Plans
                </a>
              </li>
            </ul>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2 text-xs font-bold uppercase tracking-wider text-zinc-600">
              <li>
                <a href="#" className="hover:text-[#ff4a22] transition-colors">Twitter</a>
              </li>
              <li>
                <a href="#" className="hover:text-[#ff4a22] transition-colors">LinkedIn</a>
              </li>
              <li>
                <a href="#" className="hover:text-[#ff4a22] transition-colors">Instagram</a>
              </li>
              <li>
                <a href="#" className="hover:text-[#ff4a22] transition-colors">Dribbble</a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-xs text-zinc-400 font-medium">
          <p className="max-w-md leading-relaxed">
            With GEND, your company gets more than just a website. We design experiences that resonate with your customers and drive meaningful digital engagement.
          </p>
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 text-[11px] font-bold uppercase tracking-wider text-zinc-600">
            <span>© 2026 GEND Studio. All rights reserved.</span>
